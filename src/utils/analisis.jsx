...
export function explorarDatos(frecuencia, data) {
  ...
  export function visualizarLinePlot(data, titulo, guardar = false) {
    ...
    if (guardar) {
      Plotly.downloadImage("linePlotDiv", { format: "png", filename: "lineplot" });
    }
  }
  ...
  export function visualizarBoxPlot(data, titulo, guardar = false) {
    ...
    if (guardar) {
      Plotly.downloadImage("boxPlotDiv", { format: "png", filename: "boxplot" });
    }
  }
  ...
  export function visualizarComparacionAnual(data, guardar = false) {
    ...
    if (guardar) {
      Plotly.downloadImage("comparacionAnualDiv", { format: "png", filename: "comparacionanual" });
    }
  }
